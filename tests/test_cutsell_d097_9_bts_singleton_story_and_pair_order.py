...
def test_a_strongly_corroborated_failed_singleton_leaves_story_complete():
    row = _row(
        "tg_failed_singleton", "failed",
        "corroborated_failed_singleton_unusable", label="failed",
    )
    story = derive_story_completeness([row])
    assert story["story_completeness"] == "complete"
    assert story["corroborated_failed_singleton_ids"] == ["tg_failed_singleton"]
