...
def build_semantic_equivalence_request(
    ...
    prompt = (
        ...
        "vocabulary. Recording-process speech is not an audience-facing fact: a false start, "
        "self-correction, complaint about the take, direction to a person or pet, or statement "
        "about recording must not by itself make coverage false or create a meaning conflict. "
        "Ignore only that process speech; every genuine claim intended for the audience still "
        "must survive for coverage=true. Intentional audience-facing humor remains content. "
        "When genuinely uncertain, answer same_idea=false (different) -- "
